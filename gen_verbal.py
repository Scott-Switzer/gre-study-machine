...
# ---- RC PASSAGES (volume 3, harder/longer) ----
RC += [
 {"passage":"Inflation measures the general rise in prices, but the indexes that track it rest on assumptions about how people substitute between goods. When the price of beef rises, shoppers may buy chicken; a fixed-basket index overstates the true cost of living, while a chain-weighted index better reflects actual behavior. Central banks therefore face a quiet dilemma: tighten too early and stall growth, too late and let expectations of inflation become self-fulfilling.",
  "qs":[("The passage suggests a fixed-basket index", {"A":"understates inflation","B":"may overstate the cost of living if shoppers substitute","C":"is always accurate","D":"ignores beef","E":"causes inflation"}, "B", "Stated: substitution makes a fixed basket overstate true cost."),
   ("The word 'self-fulfilling' most nearly means", {"A":"false","B":"coming true because expected","C":"tiny","D":"measured","E":"avoided"}, "B", "Self-fulfilling = realized because people expect it."),
   ("According to the passage, central banks must", {"A":"ignore inflation","B":"balance timing of tightening","C":"always tighten","D":"abolish indexes","E":"buy chicken"}, "B", "Stated: tighten too early stalls growth, too late embeds inflation.")]},
 {"passage":"The legal doctrine of stare decisis binds courts to follow precedent, promoting stability and predictability. Yet the Supreme Court has overturned its own rulings when social consensus or constitutional understanding shifted, as with school segregation and campaign finance. Critics argue that selective fidelity to precedent undermines the very predictability the doctrine promises; defenders counter that a constitution must breathe with the nation it governs.",
  "qs":[("The passage suggests stare decisis", {"A":"is never deviated from","B":"promotes stability but is sometimes overridden","C":"only applies to finance","D":"abolished segregation","E":"ignores consensus"}, "B", "The passage says courts follow precedent yet have overturned rulings when understanding shifted."),
   ("The word 'breathe' most nearly means", {"A":"stop","B":"evolve / stay living with","C":"sleep","D":"measure","E":"repeat"}, "B", "Breathe = remain responsive / alive with the nation."),
   ("According to the passage, defenders of overturning precedent argue the constitution", {"A":"is fixed","B":"must evolve with the nation","C":"ignores precedent","D":"is finance-only","E":"ended segregation"}, "B", "Stated: a constitution must breathe with the nation it governs.")]},
 {"passage":"Antibodies tag invaders for destruction, but some pathogens disguise themselves by mimicking host molecules, slipping past immune detection. HIV goes further, attacking the immune system's own command cells so the body cannot coordinate a response. Such evasion explains why a vaccine must do more than present an antigen; it must provoke the specific cellular machinery that the pathogen has learned to disable.",
  "qs":[("The passage suggests HIV is dangerous because it", {"A":"presents antigens","B":"disables the immune command cells","C":"mimics antibodies","D":"is a vaccine","E":"causes fever only"}, "B", "Stated: HIV attacks the immune system's own command cells."),
   ("The word 'mimicking' most nearly means", {"A":"destroying","B":"copying / imitating","C":"measuring","D":"ignoring","E":"vaccinating"}, "B", "Mimicking = imitating host molecules."),
   ("According to the passage, an effective vaccine must", {"A":"only present an antigen","B":"provoke the machinery the pathogen disables","C":"avoid antigens","D":"disable HIV","E":"mimic the host"}, "B", "Stated: it must provoke the specific cellular machinery the pathogen disables.")]},
 {"passage":"In economics, comparative advantage holds that nations gain by specializing in what they produce relatively most efficiently, even if another nation is absolutely better at everything. A country that is twice as good at wine and three times as good at cloth should still make cloth and trade for wine. The model assumes mobile resources and full employment, assumptions real economies violate during recessions, when the gains from trade can be unevenly distributed.",
  "qs":[("The passage suggests comparative advantage implies a nation should", {"A":"make everything itself","B":"specialize where its relative efficiency is highest","C":"avoid trade","D":"only produce wine","E":"ignore cost"}, "B", "Stated: specialize in what it produces relatively most efficiently."),
   ("The word 'relatively' most nearly means", {"A":"absolutely","B":"in comparison to others","C":"never","D":"poorly","E":"equally"}, "B", "Relatively = by comparison with the other good / nation."),
   ("According to the passage, the model's assumptions", {"A":"always hold","B":"are violated in recessions","C":"guarantee equal gains","D":"ban trade","E":"ignore cloth"}, "B", "Stated: real economies violate them during recessions.")]},
 {"passage":"Plate tectonics explains earthquakes as the release of stress where rigid plates grind past one another; the longer the lock, the larger the eventual quake. Seismologists can map faults and measure strain but cannot precisely predict the day, because the final slip depends on microscopic friction no instrument fully captures. This uncertainty is why building codes, not forecasts, remain the frontline defense against destruction.",
  "qs":[("The passage suggests quakes are", {"A":"perfectly predictable","B":"releases of accumulated plate stress","C":"caused by buildings","D":"always small","E":"microscopic"}, "B", "Stated: release of stress where plates grind past one another."),
   ("The word 'grind' most nearly means", {"A":"smooth","B":"rub with pressure","C":"float","D":"cool","E":"measure"}, "B", "Grind = rub past under pressure."),
   ("According to the passage, the main defense is", {"A":"exact forecasts","B":"building codes","C":"predicting the day","D":"ignoring faults","E":"microscopes"}, "B", "Stated: building codes, not forecasts, are the frontline defense.")]},
 {"passage":"A patent grants a temporary monopoly so inventors reap rewards and disclose methods, balancing incentive against access. Critics note that ever-lengthening protections on software and pharmaceuticals raise prices and slow follow-on innovation, especially in developing countries. Reformers propose shorter terms or compulsory licensing in health emergencies, trading some private reward for broader public benefit.",
  "qs":[("The passage suggests a patent's purpose is to", {"A":"ban invention","B":"reward inventors while disclosing methods","C":"raise all prices","D":"end competition","E":"hide methods"}, "B", "Stated: grant monopoly so inventors reap rewards and disclose methods."),
   ("The word 'compulsory' most nearly means", {"A":"optional","B":"required by authority","C":"voluntary","D":"temporary","E":"illegal"}, "B", "Compulsory = mandated / required."),
   ("According to the passage, reformers want to", {"A":"lengthen all patents","B":"trade some reward for public benefit","C":"abolish disclosure","D":"raise prices","E":"ban drugs"}, "B", "Stated: trade some private reward for broader public benefit.")]},
 {"passage":"Memory is reconstructive, not reproductive: each recall reassembles fragments, leaving room for distortion and suggestion. Eyewitness testimony, once treated as gold, is now known to be contaminate by leading questions and the confidence of others. Courts have slowly adapted, permitting expert testimony on memory's fallibility, yet juries still overweight a vivid, certain witness over probabilistic forensic evidence.",
  "qs":[("The passage suggests memory is", {"A":"a perfect recording","B":"reconstructed and distortable","C":"never wrong","D":"only visual","E":"reproductive"}, "B", "Stated: memory is reconstructive, not reproductive."),
   ("The word 'contaminate' most nearly means", {"A":"strengthen","B":"corrupt / pollute","C":"clarify","D":"measure","E":"protect"}, "B", "Contaminate = corrupted by suggestion."),
   ("According to the passage, juries tend to", {"A":"ignore witnesses","B":"overweight a vivid certain witness","C":"trust only forensics","D":"ban testimony","E":"follow experts always"}, "B", "Stated: juries overweight a vivid certain witness.")]},
 {"passage":"The tragedy of the commons arises when individuals exploit a shared resource to their own benefit, depleting it for all. Fisheries collapse when each boat catches freely; atmosphere warms when each nation emits freely. Solutions range from privatization to regulation to social norms, none perfect, but the pattern is clear: unpriced commons invite overuse unless institutions assign responsibility.",
  "qs":[("The passage suggests the tragedy of the commons occurs when", {"A":"resources are private","B":"individuals overuse a shared resource","C":"nations regulate","D":"fishing stops","E":"prices rise"}, "B", "Stated: individuals exploit a shared resource to their own benefit."),
   ("The word 'depleting' most nearly means", {"A":"refilling","B":"using up","C":"protecting","D":"pricing","E":"sharing"}, "B", "Depleting = using up / exhausting."),
   ("According to the passage, unpriced commons", {"A":"are always safe","B":"invite overuse without institutions","C":"need no rules","D":"help everyone","E":"are private"}, "B", "Stated: unpriced commons invite overuse unless institutions assign responsibility.")]},
 {"passage":"Quantum entanglement links particles so measuring one instantly fixes the other's state, regardless of distance, a feature Einstein called spooky. It enables no faster-than-light signaling, yet underpins emerging technologies for encryption and sensing. The strangeness is not a flaw in theory but a genuine feature of nature that repeated experiment has only confirmed, unsettling our intuition of locality.",
  "qs":[("The passage suggests entanglement", {"A":"allows faster-than-light messages","B":"links particle states at a distance","C":"is a theory flaw","D":"was disproven","E":"only affects light"}, "B", "Stated: links particles so measuring one fixes the other's state at distance."),
   ("The word 'spooky' most nearly means", {"A":"ordinary","B":"eerie / unsettling","C":"useful","D":"measured","E":"local"}, "B", "Spooky = eerie / unsettling to Einstein."),
   ("According to the passage, entanglement underpins", {"A":"faster travel","B":"encryption and sensing tech","C":"disproven theory","D":"locality","E":"light speed"}, "B", "Stated: underpins emerging encryption and sensing tech.")]},
 {"passage":"Urban heat islands form because pavement and roofs absorb sunlight that vegetation would reflect, raising city temperatures several degrees above surroundings. The effect worsens air quality and energy demand, but green roofs, street trees, and reflective surfaces can blunt it. Cities that treat canopy as infrastructure, not decoration, measurably cut summer peak temperatures and the deaths that follow heat waves.",
  "qs":[("The passage suggests heat islands arise because", {"A":"trees absorb sun","B":"pavement absorbs what vegetation would reflect","C":"cities are cool","D":"roofs reflect","E":"plants are rare"}, "B", "Stated: pavement/roofs absorb sunlight vegetation would reflect."),
   ("The word 'blunt' most nearly means", {"A":"sharpen","B":"reduce / soften","C":"measure","D":"ignore","E":"reflect"}, "B", "Blunt = reduce the effect."),
   ("According to the passage, canopy as infrastructure", {"A":"warms cities","B":"cuts peak temperatures and deaths","C":"is decoration only"}, "B", "Stated: measurably cuts peak temperatures and heat deaths.")]},
 {"passage":"The replication crisis in science emerged when many published results failed to reproduce, exposing lax statistical thresholds and incentives to publish positive findings. Preregistration, larger samples, and open data are now urged as remedies. Skeptics worry reform slows discovery; proponents reply that a literature of false positives is worse than a slower, trustworthy one, since policy and medicine rest on what journals report.",
  "qs":[("The passage suggests the replication crisis revealed", {"A":"perfect science","B":"unreproducible published results","C":"too few papers","D":"honest thresholds","E":"weak incentives"}, "B", "Stated: many published results failed to reproduce."),
   ("The word 'thresholds' most nearly means", {"A":"floors","B":"boundaries / cutoffs","C":"results","D":"journals","E":"samples"}, "B", "Thresholds = statistical cutoffs for significance."),
   ("According to the passage, proponents of reform hold that", {"A":"false positives are fine","B":"a trustworthy literature beats a fast false one"}, "B", "Stated: a literature of false positives is worse than slower trustworthy science.")]}
]
